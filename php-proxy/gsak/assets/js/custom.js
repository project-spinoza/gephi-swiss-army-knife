    ...
    $("#filer_input").filer({
        ...
        uploadFile: {
            ...
            success: function(data, el){
                ...
                requestAjax ("./proxy/proxy.php", {'route': 'proxyGraphFileUpload', "file": data}, function (resp) {});
            },
            error: function(el){
                	var parent = el.find(".jFiler-jProgressBar").parent();
                	el.find(".jFiler-jProgressBar").fadeOut("slow", function(){
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
        	$('#graphFileUploadForm input[type="submit"]').prop('disabled', true);
            var file = file.name;
            $.get('./proxy/proxy.php', {file: file, 'route' : 'removeUpload'});
        },
        onEmpty: null,
        options: null,
        captions: {
    ...
    $("#filer_input_graph").filer({
        ...
        uploadFile: {
            ...
            success: function(data, el){
            	...
            	isFileUploaded = true;
                requestAjax ("./proxy/proxy.php", {'route': 'proxyFileUpload', "file": data}, function (resp) {});
